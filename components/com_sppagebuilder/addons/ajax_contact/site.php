    ...
    public function render() {
        ...
        if ($use_custom_button) {
            ...
            if ($button_icon_position == 'left') {
                $button_text = ($button_icon) ? '<span class="fa ' . $button_icon . '"></span> ' . $button_text : $button_text;
            } else {
                $button_text = ($button_icon) ? $button_text . ' <span class="fa ' . $button_icon . '"></span>' : $button_text;
            }
        }
