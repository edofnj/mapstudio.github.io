...
class SppagebuilderAddonCountdown extends SppagebuilderAddons{
	...
	public function css() {
		...
		$label_style_sm .= (isset($settings->label_margin_sm) && $settings->label_margin_sm) ? "margin: " . $settings->label_margin_sm  . ";" : '';
		...
		$label_style_xs .= (isset($settings->label_margin_xs) && $settings->label_margin_xs) ? "margin: " . $settings->label_margin_xs  . ";" : '';
