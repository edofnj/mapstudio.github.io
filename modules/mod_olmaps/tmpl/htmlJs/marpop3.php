...
var map = new ol.Map({layers: [new ol.layer.Tile({ source: new ol.source.OSM()})],overlays: [overlay], target: 'ol_map', view: new ol.View({center: ol.proj.fromLonLat([centerLon, centerLat]), zoom: myZoom})});
